...
describe VCAP::Services::ActiveMQ::Provisioner do
  before :all do
    logger = Logger.new(STDOUT, "daily")
    logger.level = Logger::DEBUG
    EM.run do
      @provisioner = VCAP::Services::ActiveMQ::Provisioner.new({:logger => logger, :plan_management => {:plans => {:free => {:low_water => 10}}}})
